...
from fairreckitlib.data.set.dataset_registry import  *
...
if __name__ == '__main__':
    data_dir_D = os.path.join('C:/Users/Lennard C/Downloads/test_results')
    data_dir_tests = "C:/Users/Lennard C/OneDrive/Documents/Informatica_UU/Software_project/program/lib/fair-rec-kit-lib/tests/datasets"

    rec_sys = RecommenderSystem(
        data_dir_tests,
        os.path.join('fairreckitlib/data', '..', 'results')
    )
